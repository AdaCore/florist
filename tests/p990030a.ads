...
package P990030a is new P9900x0
  (Version => "30",
   ...
   Await_All_Jobs_Done => P990001b.Await_All_Jobs_Done,
   Await_Start => P990001b.Await_Start,
   Done_Job => P990001b.Done_Job,
   Finalize_Sync => P990001b.Finalize,
   Initialize_Scheduling => P990002c.Initialize_Scheduling,
   Finalize_Scheduling => P990002c.Finalize,
   Reschedule => P990002c.Reschedule,
