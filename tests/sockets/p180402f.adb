...
procedure p180402f is
   ...
   is
      Sent    : POSIX.IO_Count;
   begin
      Send_Message (Socket, Message, Sent);
      if Er1 /= "" then
...
--   Test ("package POSIX.Sockets");
   ...
   declare
      ...
      Buffer3        : POSIX_String := "It was sent using Send_Message2. ";
   ...
   begin
      ...
      Send_Message2_Tests (Socket, Message, Er2 => "Af01", Er3 => "Af02");
      Close (Socket);
   exception
      when E : others => Unexpected_Exception (E, "Af03");
   end;
   ...
   begin
      Close (Socket);
      Send_Message2_Tests (Socket, Message,
                   Expected => Bad_File_Descriptor, Er1 => "Af04",
                   Er2 => "Af05", Er3 => "Af06");
   exception
      when E : others => Unexpected_Exception (E, "Af07");
   end;
   ...
   begin
      ...
      Send_Message2_Tests (Socket, Message,
                   Expected => Not_Connected, Er1 => "Af08",
                   Er2 => "Af09", Er3 => "Af10");
   exception
      when E : others => Unexpected_Exception (E, "Af11");
   end;
   ...
   begin
      Send_Message2_Tests (Socket, Message,
                   Expected => Not_A_Socket, Er1 => "Af12",
                   Er2 => "Af13", Er3 => "Af14");
   exception
      when E : others => Unexpected_Exception (E, "Af15");
   end;

   Done;
exception when E : others => Fatal_Exception (E, "Af16");
end p180402f;
