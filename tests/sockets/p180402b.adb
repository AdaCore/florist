...
procedure p180402b is
   ...
   is
      Sent    : POSIX.IO_Count;
   begin
      Send (Socket, Buffer, 11, Sent, Mask);
      if Er1 /= "" then
...
--   Test ("package POSIX.Sockets");
   ...
   declare
      ...
      Buffer  : POSIX_String (1 .. 11) := "Send 1 test";
   begin
      ...
      Connect (Socket, +Name);
      Send1_Tests (Socket, Buffer'Address);
      Close (Socket);
   exception
      when E : others => Unexpected_Exception (E, "Ab01");
   end;
   ...
   begin
      Close (Socket);
      Send1_Tests (Socket, Buffer'Address,
                   Expected => Bad_File_Descriptor, Er1 => "Ab02",
                   Er2 => "Ab03", Er3 => "Ab04");
   exception
      when E : others => Unexpected_Exception (E, "Ab05");
   end;
   ...
   begin
      Socket := Create (PF_INET, Stream_Socket, IPPROTO_TCP);
      Send1_Tests (Socket, Buffer'Address,
                   Expected => Not_Connected, Er1 => "Ab06",
                   Er2 => "Ab07", Er3 => "Ab08");
   exception
      when E : others => Unexpected_Exception (E, "Ab09");
   end;
   ...
   begin
      Send1_Tests (Socket, Buffer'Address,
                   Expected => Not_A_Socket, Er1 => "Ab10",
                   Er2 => "Ab11", Er3 => "Ab12");
   exception
      when E : others => Unexpected_Exception (E, "Ab13");
   end;
   ...
   when E1 : POSIX_Error =>
      if Get_Error_Code /= Is_Already_Connected then
         Unexpected_Exception (E1, "Ab14");
      end if;
   when E2 : others => Unexpected_Exception (E2, "Ab15");
   end;


   Done;

exception when E : others => Fatal_Exception (E, "Ab17");
end p180402b;
